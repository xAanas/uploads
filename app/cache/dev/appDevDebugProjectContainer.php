...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'image_filesystem' => 'getImageFilesystemService',
            'jb_fileupload.crop.validator' => 'getJbFileupload_Crop_ValidatorService',
            'jb_fileupload.file_owner.validator' => 'getJbFileupload_FileOwner_ValidatorService',
            'jb_fileupload.image.validator' => 'getJbFileupload_Image_ValidatorService',
            'jb_fileuploader.crop.manager' => 'getJbFileuploader_Crop_ManagerService',
            'jb_fileuploader.croper' => 'getJbFileuploader_CroperService',
            'jb_fileuploader.endpoint_configuration' => 'getJbFileuploader_EndpointConfigurationService',
            'jb_fileuploader.file_ajax.upload_listener' => 'getJbFileuploader_FileAjax_UploadListenerService',
            'jb_fileuploader.file_ajax.validation_listener' => 'getJbFileuploader_FileAjax_ValidationListenerService',
            'jb_fileuploader.file_history.manager' => 'getJbFileuploader_FileHistory_ManagerService',
            'jb_fileuploader.form.type.crop' => 'getJbFileuploader_Form_Type_CropService',
            'jb_fileuploader.form.type.crop_image_ajax' => 'getJbFileuploader_Form_Type_CropImageAjaxService',
            'jb_fileuploader.form.type.file_ajax' => 'getJbFileuploader_Form_Type_FileAjaxService',
            'jb_fileuploader.form.type.image_ajax' => 'getJbFileuploader_Form_Type_ImageAjaxService',
            'jb_fileuploader.resolver_chain' => 'getJbFileuploader_ResolverChainService',
            'jb_fileuploader.twig_extension.crop' => 'getJbFileuploader_TwigExtension_CropService',
            'jb_fileuploader.upload_resolver' => 'getJbFileuploader_UploadResolverService',
            'jb_fileuploader.validator.manager' => 'getJbFileuploader_Validator_ManagerService',
            'jb_fileuploader.validator_chain' => 'getJbFileuploader_ValidatorChainService',
            ...
            'liip_imagine.binary.loader.stream.image_filesystem' => 'getLiipImagine_Binary_Loader_Stream_ImageFilesystemService',
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('oneup_uploader.post_persist', array(0 => 'jb_fileuploader.file_ajax.upload_listener', 1 => 'onUpload'), 0);
        $instance->addListenerService('oneup_uploader.validation', array(0 => 'jb_fileuploader.file_ajax.validation_listener', 1 => 'onValidate'), 0);
    ...
    protected function getDebug_Templating_Engine_PhpService()
    {
        ...
        $instance->setHelpers(array('slots' => 'templating.helper.slots', 'assets' => 'templating.helper.assets', 'request' => 'templating.helper.request', 'session' => 'templating.helper.session', 'router' => 'templating.helper.router', 'actions' => 'templating.helper.actions', 'code' => 'templating.helper.code', 'translator' => 'templating.helper.translator', 'form' => 'templating.helper.form', 'stopwatch' => 'templating.helper.stopwatch', 'logout_url' => 'templating.helper.logout_url', 'security' => 'templating.helper.security', 'assetic' => 'assetic.helper.dynamic', 'oneup_uploader' => 'oneup_uploader.templating.uploader_helper', 'imagine' => 'liip_imagine.templating.helper'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'chargement', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\vendor\\jbouzekri\\file-uploader-bundle\\Jb\\Bundle\\FileUploaderBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Login\\LoginBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Jb\\Bundle\\FileUploaderBundle\\Entity');
        $c->addDriver($b, 'Login\\LoginBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('JbFileUploaderBundle' => 'Jb\\Bundle\\FileUploaderBundle\\Entity', 'LoginLoginBundle' => 'Login\\LoginBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_cde6a979c76c17b7ef8827fef74c1c79580ec81315828c779b859495193076a4');
    ...
    {
        return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension($this, array('form' => 'form.type.form', 'birthday' => 'form.type.birthday', 'checkbox' => 'form.type.checkbox', 'choice' => 'form.type.choice', 'collection' => 'form.type.collection', 'country' => 'form.type.country', 'date' => 'form.type.date', 'datetime' => 'form.type.datetime', 'email' => 'form.type.email', 'file' => 'form.type.file', 'hidden' => 'form.type.hidden', 'integer' => 'form.type.integer', 'language' => 'form.type.language', 'locale' => 'form.type.locale', 'money' => 'form.type.money', 'number' => 'form.type.number', 'password' => 'form.type.password', 'percent' => 'form.type.percent', 'radio' => 'form.type.radio', 'repeated' => 'form.type.repeated', 'search' => 'form.type.search', 'textarea' => 'form.type.textarea', 'text' => 'form.type.text', 'time' => 'form.type.time', 'timezone' => 'form.type.timezone', 'url' => 'form.type.url', 'button' => 'form.type.button', 'submit' => 'form.type.submit', 'reset' => 'form.type.reset', 'currency' => 'form.type.currency', 'entity' => 'form.type.entity', 'liip_imagine_image' => 'liip_imagine.form.type.image', 'jb_file_ajax' => 'jb_fileuploader.form.type.file_ajax', 'jb_image_ajax' => 'jb_fileuploader.form.type.image_ajax', 'jb_crop_image_ajax' => 'jb_fileuploader.form.type.crop_image_ajax', 'jb_fileuploader_crop' => 'jb_fileuploader.form.type.crop'), array('form' => array(0 => 'form.type_extension.form.http_foundation', 1 => 'form.type_extension.form.validator', 2 => 'form.type_extension.csrf', 3 => 'form.type_extension.form.data_collector'), 'repeated' => array(0 => 'form.type_extension.repeated.validator'), 'submit' => array(0 => 'form.type_extension.submit.validator')), array(0 => 'form.type_guesser.validator', 1 => 'form.type_guesser.doctrine'))), $this->get('form.resolved_type_factory'));
    }
    ...
    /**
     * Gets the 'image_filesystem' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getImageFilesystemService()
    {
        return $this->services['image_filesystem'] = new \Gaufrette\Filesystem(new \Gaufrette\Adapter\Local(($this->targetDirs[2].'/../web/uploads'), true));
    }

    /**
     * Gets the 'jb_fileupload.crop.validator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jb\Bundle\FileUploaderBundle\Service\Validator\CropValidator A Jb\Bundle\FileUploaderBundle\Service\Validator\CropValidator instance.
     */
    protected function getJbFileupload_Crop_ValidatorService()
    {
        return $this->services['jb_fileupload.crop.validator'] = new \Jb\Bundle\FileUploaderBundle\Service\Validator\CropValidator();
    }

    /**
     * Gets the 'jb_fileupload.file_owner.validator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jb\Bundle\FileUploaderBundle\Service\Validator\Constraints\FileOwnerValidator A Jb\Bundle\FileUploaderBundle\Service\Validator\Constraints\FileOwnerValidator instance.
     */
    protected function getJbFileupload_FileOwner_ValidatorService()
    {
        return $this->services['jb_fileupload.file_owner.validator'] = new \Jb\Bundle\FileUploaderBundle\Service\Validator\Constraints\FileOwnerValidator($this->get('doctrine.orm.default_entity_manager'), $this->get('security.token_storage'));
    }

    /**
     * Gets the 'jb_fileupload.image.validator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jb\Bundle\FileUploaderBundle\Service\Validator\ImageValidator A Jb\Bundle\FileUploaderBundle\Service\Validator\ImageValidator instance.
     */
    protected function getJbFileupload_Image_ValidatorService()
    {
        return $this->services['jb_fileupload.image.validator'] = new \Jb\Bundle\FileUploaderBundle\Service\Validator\ImageValidator();
    }

    /**
     * Gets the 'jb_fileuploader.crop.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jb\Bundle\FileUploaderBundle\Service\CropFileManager A Jb\Bundle\FileUploaderBundle\Service\CropFileManager instance.
     */
    protected function getJbFileuploader_Crop_ManagerService()
    {
        return $this->services['jb_fileuploader.crop.manager'] = new \Jb\Bundle\FileUploaderBundle\Service\CropFileManager($this->get('liip_imagine.data.manager'), $this->get('liip_imagine.filter.manager'), $this->get('knp_gaufrette.filesystem_map'), $this->get('jb_fileuploader.endpoint_configuration'));
    }

    /**
     * Gets the 'jb_fileuploader.croper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jb\Bundle\FileUploaderBundle\Service\Croper A Jb\Bundle\FileUploaderBundle\Service\Croper instance.
     * 
     * @throws InactiveScopeException when the 'jb_fileuploader.croper' service is requested while the 'request' scope is not active
     */
    protected function getJbFileuploader_CroperService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('jb_fileuploader.croper', 'request');
        }

        return $this->services['jb_fileuploader.croper'] = $this->scopedServices['request']['jb_fileuploader.croper'] = new \Jb\Bundle\FileUploaderBundle\Service\Croper($this->get('jb_fileuploader.crop.manager'), $this->get('jb_fileuploader.resolver_chain'), $this->get('jb_fileuploader.endpoint_configuration'), $this->get('jb_fileuploader.validator.manager'));
    }

    /**
     * Gets the 'jb_fileuploader.endpoint_configuration' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jb\Bundle\FileUploaderBundle\Service\EndpointConfiguration A Jb\Bundle\FileUploaderBundle\Service\EndpointConfiguration instance.
     */
    protected function getJbFileuploader_EndpointConfigurationService()
    {
        return $this->services['jb_fileuploader.endpoint_configuration'] = new \Jb\Bundle\FileUploaderBundle\Service\EndpointConfiguration(array('resolvers' => array('upload' => array('assets' => array('directory' => 'uploads'))), 'endpoints' => array('gallery' => array('upload_resolver' => 'upload', 'upload_validators' => array(), 'crop_validators' => array())), 'crop_route' => 'jb_image_crop_endpoint'));
    }

    /**
     * Gets the 'jb_fileuploader.file_ajax.upload_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jb\Bundle\FileUploaderBundle\EventListener\Upload\UploadListener A Jb\Bundle\FileUploaderBundle\EventListener\Upload\UploadListener instance.
     * 
     * @throws InactiveScopeException when the 'jb_fileuploader.file_ajax.upload_listener' service is requested while the 'request' scope is not active
     */
    protected function getJbFileuploader_FileAjax_UploadListenerService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('jb_fileuploader.file_ajax.upload_listener', 'request');
        }

        return $this->services['jb_fileuploader.file_ajax.upload_listener'] = $this->scopedServices['request']['jb_fileuploader.file_ajax.upload_listener'] = new \Jb\Bundle\FileUploaderBundle\EventListener\Upload\UploadListener($this->get('jb_fileuploader.file_history.manager'));
    }

    /**
     * Gets the 'jb_fileuploader.file_ajax.validation_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jb\Bundle\FileUploaderBundle\EventListener\Validation\ConfiguredValidationListener A Jb\Bundle\FileUploaderBundle\EventListener\Validation\ConfiguredValidationListener instance.
     */
    protected function getJbFileuploader_FileAjax_ValidationListenerService()
    {
        return $this->services['jb_fileuploader.file_ajax.validation_listener'] = new \Jb\Bundle\FileUploaderBundle\EventListener\Validation\ConfiguredValidationListener($this->get('jb_fileuploader.validator.manager'));
    }

    /**
     * Gets the 'jb_fileuploader.file_history.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jb\Bundle\FileUploaderBundle\Service\FileHistoryManager A Jb\Bundle\FileUploaderBundle\Service\FileHistoryManager instance.
     * 
     * @throws InactiveScopeException when the 'jb_fileuploader.file_history.manager' service is requested while the 'request' scope is not active
     */
    protected function getJbFileuploader_FileHistory_ManagerService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('jb_fileuploader.file_history.manager', 'request');
        }

        return $this->services['jb_fileuploader.file_history.manager'] = $this->scopedServices['request']['jb_fileuploader.file_history.manager'] = new \Jb\Bundle\FileUploaderBundle\Service\FileHistoryManager($this->get('doctrine.orm.default_entity_manager'), $this->get('security.context'), $this->get('jb_fileuploader.resolver_chain'), $this->get('jb_fileuploader.endpoint_configuration'));
    }

    /**
     * Gets the 'jb_fileuploader.form.type.crop' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jb\Bundle\FileUploaderBundle\Form\Type\CropType A Jb\Bundle\FileUploaderBundle\Form\Type\CropType instance.
     */
    protected function getJbFileuploader_Form_Type_CropService()
    {
        return $this->services['jb_fileuploader.form.type.crop'] = new \Jb\Bundle\FileUploaderBundle\Form\Type\CropType();
    }

    /**
     * Gets the 'jb_fileuploader.form.type.crop_image_ajax' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jb\Bundle\FileUploaderBundle\Form\Type\CropImageAjaxType A Jb\Bundle\FileUploaderBundle\Form\Type\CropImageAjaxType instance.
     * 
     * @throws InactiveScopeException when the 'jb_fileuploader.form.type.crop_image_ajax' service is requested while the 'request' scope is not active
     */
    protected function getJbFileuploader_Form_Type_CropImageAjaxService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('jb_fileuploader.form.type.crop_image_ajax', 'request');
        }

        return $this->services['jb_fileuploader.form.type.crop_image_ajax'] = $this->scopedServices['request']['jb_fileuploader.form.type.crop_image_ajax'] = new \Jb\Bundle\FileUploaderBundle\Form\Type\CropImageAjaxType($this->get('jb_fileuploader.file_history.manager'));
    }

    /**
     * Gets the 'jb_fileuploader.form.type.file_ajax' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jb\Bundle\FileUploaderBundle\Form\Type\FileAjaxType A Jb\Bundle\FileUploaderBundle\Form\Type\FileAjaxType instance.
     * 
     * @throws InactiveScopeException when the 'jb_fileuploader.form.type.file_ajax' service is requested while the 'request' scope is not active
     */
    protected function getJbFileuploader_Form_Type_FileAjaxService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('jb_fileuploader.form.type.file_ajax', 'request');
        }

        return $this->services['jb_fileuploader.form.type.file_ajax'] = $this->scopedServices['request']['jb_fileuploader.form.type.file_ajax'] = new \Jb\Bundle\FileUploaderBundle\Form\Type\FileAjaxType($this->get('jb_fileuploader.file_history.manager'));
    }

    /**
     * Gets the 'jb_fileuploader.form.type.image_ajax' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jb\Bundle\FileUploaderBundle\Form\Type\ImageAjaxType A Jb\Bundle\FileUploaderBundle\Form\Type\ImageAjaxType instance.
     * 
     * @throws InactiveScopeException when the 'jb_fileuploader.form.type.image_ajax' service is requested while the 'request' scope is not active
     */
    protected function getJbFileuploader_Form_Type_ImageAjaxService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('jb_fileuploader.form.type.image_ajax', 'request');
        }

        return $this->services['jb_fileuploader.form.type.image_ajax'] = $this->scopedServices['request']['jb_fileuploader.form.type.image_ajax'] = new \Jb\Bundle\FileUploaderBundle\Form\Type\ImageAjaxType($this->get('jb_fileuploader.file_history.manager'));
    }

    /**
     * Gets the 'jb_fileuploader.resolver_chain' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jb\Bundle\FileUploaderBundle\Service\ResolverChain A Jb\Bundle\FileUploaderBundle\Service\ResolverChain instance.
     * 
     * @throws InactiveScopeException when the 'jb_fileuploader.resolver_chain' service is requested while the 'request' scope is not active
     */
    protected function getJbFileuploader_ResolverChainService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('jb_fileuploader.resolver_chain', 'request');
        }

        $this->services['jb_fileuploader.resolver_chain'] = $this->scopedServices['request']['jb_fileuploader.resolver_chain'] = $instance = new \Jb\Bundle\FileUploaderBundle\Service\ResolverChain();

        $instance->addResolver($this->get('jb_fileuploader.upload_resolver'), 'upload');

        return $instance;
    }

    /**
     * Gets the 'jb_fileuploader.twig_extension.crop' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jb\Bundle\FileUploaderBundle\Twig\CropExtension A Jb\Bundle\FileUploaderBundle\Twig\CropExtension instance.
     */
    protected function getJbFileuploader_TwigExtension_CropService()
    {
        return $this->services['jb_fileuploader.twig_extension.crop'] = new \Jb\Bundle\FileUploaderBundle\Twig\CropExtension($this->get('router'), 'jb_image_crop_endpoint');
    }

    /**
     * Gets the 'jb_fileuploader.upload_resolver' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jb\Bundle\FileUploaderBundle\Service\Resolver\AssetsResolver A Jb\Bundle\FileUploaderBundle\Service\Resolver\AssetsResolver instance.
     * 
     * @throws InactiveScopeException when the 'jb_fileuploader.upload_resolver' service is requested while the 'request' scope is not active
     */
    protected function getJbFileuploader_UploadResolverService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('jb_fileuploader.upload_resolver', 'request');
        }

        return $this->services['jb_fileuploader.upload_resolver'] = $this->scopedServices['request']['jb_fileuploader.upload_resolver'] = new \Jb\Bundle\FileUploaderBundle\Service\Resolver\AssetsResolver($this->get('templating.helper.assets'), 'uploads');
    }

    /**
     * Gets the 'jb_fileuploader.validator.manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jb\Bundle\FileUploaderBundle\Service\ValidatorManager A Jb\Bundle\FileUploaderBundle\Service\ValidatorManager instance.
     */
    protected function getJbFileuploader_Validator_ManagerService()
    {
        return $this->services['jb_fileuploader.validator.manager'] = new \Jb\Bundle\FileUploaderBundle\Service\ValidatorManager($this->get('jb_fileuploader.validator_chain'), $this->get('jb_fileuploader.endpoint_configuration'));
    }

    /**
     * Gets the 'jb_fileuploader.validator_chain' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Jb\Bundle\FileUploaderBundle\Service\ValidatorChain A Jb\Bundle\FileUploaderBundle\Service\ValidatorChain instance.
     */
    protected function getJbFileuploader_ValidatorChainService()
    {
        $this->services['jb_fileuploader.validator_chain'] = $instance = new \Jb\Bundle\FileUploaderBundle\Service\ValidatorChain();

        $instance->addValidator($this->get('jb_fileupload.image.validator'), 'Image');
        $instance->addValidator($this->get('jb_fileupload.crop.validator'), 'Crop');
    ...
    {
        return $this->services['knp_gaufrette.filesystem_map'] = new \Knp\Bundle\GaufretteBundle\FilesystemMap(array('image' => $this->get('image_filesystem')));
    }
    ...
    /**
     * Gets the 'liip_imagine.binary.loader.stream.image_filesystem' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Liip\ImagineBundle\Binary\Loader\StreamLoader A Liip\ImagineBundle\Binary\Loader\StreamLoader instance.
     */
    protected function getLiipImagine_Binary_Loader_Stream_ImageFilesystemService()
    {
        return $this->services['liip_imagine.binary.loader.stream.image_filesystem'] = new \Liip\ImagineBundle\Binary\Loader\StreamLoader('gaufrette://image/', NULL);
    }
    ...
    protected function getLiipImagine_Data_ManagerService()
    {
        ...
        $instance->addLoader('stream.image_filesystem', $this->get('liip_imagine.binary.loader.stream.image_filesystem'));
    ...
    {
        return $this->services['liip_imagine.filter.configuration'] = new \Liip\ImagineBundle\Imagine\Filter\FilterConfiguration(array('original' => array('quality' => 100, 'format' => NULL, 'animated' => false, 'cache' => NULL, 'data_loader' => NULL, 'default_image' => NULL, 'filters' => array(), 'post_processors' => array()), 'thumb_from_original' => array('data_loader' => 'stream.image_filesystem', 'quality' => 75, 'filters' => array('thumbnail' => array('size' => array(0 => 120, 1 => 90), 'mode' => 'outbound')), 'format' => NULL, 'animated' => false, 'cache' => NULL, 'default_image' => NULL, 'post_processors' => array())));
    }
    ...
    {
        return $this->services['oneup_uploader.routing.loader'] = new \Oneup\UploaderBundle\Routing\RouteLoader(array('gallery' => array(0 => 'oneup_uploader.controller.gallery', 1 => array('enable_progress' => false, 'enable_cancelation' => false, 'route_prefix' => ''))));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Oneup\UploaderBundle\Uploader\Storage\GaufretteStorage A Oneup\UploaderBundle\Uploader\Storage\GaufretteStorage instance.
     */
    protected function getOneupUploader_Storage_GalleryService()
    {
        return $this->services['oneup_uploader.storage.gallery'] = new \Oneup\UploaderBundle\Uploader\Storage\GaufretteStorage($this->get('image_filesystem'), 102400, 'gaufrette://image/', '');
    }
    ...
    {
        return $this->services['oneup_uploader.templating.uploader_helper'] = new \Oneup\UploaderBundle\Templating\Helper\UploaderHelper($this->get('router'), array('gallery' => 3145728));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Login\\LoginBundle\\Entity\\Users' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha1', 1 => false, 2 => 1))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DemoSecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.demo_secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.chain_provider'), 1 => $this->get('security.user.provider.concrete.in_memory'), 2 => $this->get('security.user.provider.concrete.user_db')), 'demo_secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'demo_secured_area', $g, $h, array('check_path' => '_demo_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'demo_secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '_demo_login', false), NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.chain_provider'), 1 => $this->get('security.user.provider.concrete.in_memory'), 2 => $this->get('security.user.provider.concrete.user_db')), 'secured_area', $b, $c), 2 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'secured_area', $g, $h, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 3 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5540fb08cc609', $b, $f), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/login', false), NULL, NULL, $b));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'JbFileUploaderBundle:Form:fields.html.twig'), 'autoescape' => array(0 => 'Symfony\\Bundle\\TwigBundle\\TwigDefaultEscapingStrategy', 1 => 'guess'), 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'JbFileUploaderBundle:Form:fields.html.twig', 2 => 'LiipImagineBundle:Form:form_div_layout.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        ...
        $instance->addExtension($this->get('jb_fileuploader.twig_extension.crop'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Upload\\UploadBundle/Resources/views'), 'Upload');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\liip\\imagine-bundle\\Liip\\ImagineBundle/Resources/views'), 'LiipImagine');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\jbouzekri\\file-uploader-bundle\\Jb\\Bundle\\FileUploaderBundle/Resources/views'), 'JbFileUploader');
        $instance->addPath(($this->targetDirs[3].'\\src\\Login\\LoginBundle/Resources/views'), 'LoginLogin');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('validator.expression' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\EmailValidator' => 'validator.email', 'security.validator.user_password' => 'security.validator.user_password', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique', 'jb_file_owner' => 'jb_fileupload.file_owner.validator')));
    ...
    {
        return $this->services['security.user.provider.concrete.user_db'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Login\\LoginBundle\\Entity\\Users', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'UploadBundle' => 'Upload\\UploadBundle\\UploadBundle',
                ...
                'JbFileUploaderBundle' => 'Jb\\Bundle\\FileUploaderBundle\\JbFileUploaderBundle',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'JbFileUploaderBundle:Form:fields.html.twig',
            ...
            'jb_fileuploader.endpoints' => array(
                'resolvers' => array(
                    'upload' => array(
                        'assets' => array(
                            'directory' => 'uploads',
            ...
            'jb_fileuploader.crop_route' => 'jb_image_crop_endpoint',
